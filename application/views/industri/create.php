...
                            <?php else:?>
                ...
                <div class="inner-w3pvt-page-info">
                    <ol class="breadcrumb d-flex">
                        ...
                        <li class="breadcrumb-item active">Tambah Senarai Syarikat/Industri</li>
                    </ol>
                </div>
                <!--//breadcrumb-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mt40">
                    <div class="pull-left">
                        <h2>DAFTAR SYARIKAT/INDUSTRI</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="syarikat" class="form-control" placeholder="Nama Syarikat/Industri">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="alamat" class="form-control" placeholder="Alamat Syarikat/Industri">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" col="4" name="phone" placeholder="No. Telefon"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" col="4" name="email" placeholder="Alamat Email"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" col="4" name="tahun" placeholder="Tahun Syarikat/Industri Ditubuhkan"></textarea>
                        </div>
                    </div>
