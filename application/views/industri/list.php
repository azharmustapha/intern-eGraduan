    ...
    <!-- //home -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <h2>SENARAI SYARIKAT/INDUSTRI YANG BERDAFTAR</h2>
                </div>

                <div class="col-md-2">
                    <a href="<?php echo base_url('industri/create/') ?>" class="btn btn-dark"><i class="fa fa-plus"></i> Syarikat/Industri</a>
                </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php if($industri): ?>
                    <?php foreach($industri as $industri): ?>
                    <tr>
                        <td><?php echo $industri->id; ?></td>
                        <td><?php echo $industri->syarikat; ?></td>
                        <td><?php echo $industri->alamat; ?></td>
                        <td><?php echo $industri->phone; ?></td>
                        <td><?php echo $industri->email; ?></td>
                        <td><?php echo $industri->tahun; ?></td>
                        <td><a href="<?php echo base_url('industri/edit/'.$industri->id) ?>" class="btn btn-primary"><i class="fa fa-pencil"></i> Sunting</a></td>
                        <td>
                            <form action="<?php echo base_url('industri/delete/'.$industri->id) ?>" method="post">
                            <button class="btn btn-danger" type="submit"><i class="fa fa-trash"></i> Padam</button>
                            </form>
                        </td>
                    </tr>
                    <?php endforeach; ?>
