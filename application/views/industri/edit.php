...
                            <?php else:?>
                ...
                <div class="inner-w3pvt-page-info">
                    <ol class="breadcrumb d-flex">
                        ...
                        <li class="breadcrumb-item active">Syarikat/Industri</li>

                        <li class="breadcrumb-item active">Sunting Senarai Syarikat/Industri</li>
                    </ol>
                </div>
                <!--//breadcrumb-->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 mt40">
                <div class="pull-left">
                    <h2>SUNTING MAKLUMAT SYARIKAT/INDUSTRI</h2>
                </div>
            </div>
        </div>
        ...
        <form action="<?php echo base_url('industri/store') ?>" method="POST" name="edit_industri">
        <input type="hidden" name="id" value="<?php echo $industri->id ?>">
            <div class="row">

                <div class="col-md-12">
                    <div class="form-group">
                        <strong>Nama Syarikat/Industri</strong>
                        <input type="text" name="syarikat" class="form-control" value="<?php echo $industri->syarikat ?>" placeholder="Tajuk Iklan">
                    </div>
                </div>

                <div class="col-md-12">
                    <div class="form-group">
                        <strong>Alamat Syarikat/Industri</strong>
                        <input type="text" name="alamat" class="form-control" value="<?php echo $industri->alamat ?>" placeholder="Nama Jawatan Kosong">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" col="4" name="phone" placeholder="Huraian Iklan"><?php echo $industri->phone ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" col="4" name="email" placeholder="Link Permohonan"><?php echo $industri->email ?></textarea>
                    </div>
                </div>

                <div class="col-md-12">
                    <div class="form-group">
                    <strong>Tahun Syarikat/Industri Ditubuhkan</strong>
                        <textarea class="form-control" col="4" name="tahun" placeholder="Link Permohonan"><?php echo $industri->tahun ?></textarea>
                    </div>
                </div>
