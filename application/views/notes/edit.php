...
                            <?php else:?>
                ...
                <div class="inner-w3pvt-page-info">
                    <ol class="breadcrumb d-flex">
                        ...
                        <li class="breadcrumb-item active">Sunting Iklan</li>
                    </ol>
                </div>
                <!--//breadcrumb-->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" value="<?php echo $note->title ?>" placeholder="Tajuk Iklan">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="jawatan" class="form-control" value="<?php echo $note->jawatan ?>" placeholder="Nama Jawatan Kosong">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" col="4" name="description" placeholder="Huraian Iklan"><?php echo $note->description ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" col="4" name="linkk" placeholder="Link Permohonan"><?php echo $note->linkk ?></textarea>
                    </div>
                </div>
