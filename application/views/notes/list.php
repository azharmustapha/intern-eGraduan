    ...
    <br />
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <h2>IKLAN PEKERJAAN</h2>
                </div>

                <div class="col-md-2">
                    <a href="<?php echo base_url('note/create/') ?>" class="btn btn-dark"><i class="fa fa-plus"></i> Tambah Iklan</a>
                </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $note->linkk; ?></td>
                        <td><a href="<?php echo base_url('note/edit/'.$note->id) ?>" class="btn btn-primary"><i class="fa fa-pencil"></i> Sunting</a></td>
                        <td>
